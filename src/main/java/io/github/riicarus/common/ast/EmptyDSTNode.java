 ...
 *
 * @author Riicarus
 * @create 2023-12-17 17:48
 * @since 1.0.0
 */
public class EmptyDSTNode extends DSTNode {

    public static final ASTCreator<EmptyDSTNode> CREATOR =
            children -> new EmptyDSTNode(
                    (TerminalASTNode) children.get(0)
            );

    private final TerminalASTNode eps;

    public EmptyDSTNode(TerminalASTNode eps) {
        this.eps = eps;
    }
